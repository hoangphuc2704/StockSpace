...
const WalletTenant = () => {
  ...
  // State điều khiển Modal nạp tiền
      ...
      <div className="flex pt-14">
        ...
        >
          <main className="mx-auto w-full max-w-4000 space-y-6 p-6 md:p-8">
            ...
            <div className="flex flex-col justify-between gap-4 md:flex-row md:items-center">
              <div>
                ...
                <p className="text-sm text-slate-500">
                  Quản lý số dư, nạp tiền và theo dõi lịch sử thanh toán của bạn.
                </p>
              </div>
            ...
            {/* Lịch sử giao dịch */}
            <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
              <h3 className="mb-4 text-lg font-bold text-slate-900">Lịch sử giao dịch</h3>
              <DataTable columns={columns} data={transactions} isLoading={loadingTransactions} />
