...
const AnalyticsPage = () => {
  ...
  const toggleSidebar = () => {
    // Tự động nhận diện thiết bị: Desktop thu gọn sidebar, Mobile bật menu tràn viền
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans text-slate-900">
      ...
      <div className="flex pt-14">
        {/* 2. SIDEBAR (Thay thế toàn bộ cụm code cũ bằng component dùng chung) */}
        <Sidebar
          isSidebarExpanded={isSidebarExpanded}
          isMobileOpen={isMobileOpen}
          setIsMobileOpen={setIsMobileOpen}
          currentRole="ADMIN" // Đồng bộ menu quyền ADMIN với AdminDashboard
        />
