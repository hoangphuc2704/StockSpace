      ...
      >
        ...
        <div className="mb-5 flex items-start justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="font-mono text-xs text-slate-400">{shortId(warehouse.id)}</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="space-y-3 text-sm">
          ...
          <div className="flex flex-wrap items-center gap-2 rounded-xl border border-slate-100 bg-slate-50 px-4 py-3">
            ...
            <Badge
              variant={warehouse.isVerified ? 'success' : 'warning'}
              size="sm"
...
const WareHouseManagementPage = () => {
  ...
  // ✅ ĐÃ ĐỒNG BỘ TRẠNG THÁI SIDEBAR GIỐNG ADMIN DASHBOARD
    ...
    <div className="min-h-screen bg-slate-50 font-sans text-slate-900">
      ...
      <header className="fixed top-0 right-0 left-0 z-50 flex h-14 items-center border-b border-slate-200 bg-white px-4">
        <div className="flex items-center gap-4">
          {/* ✅ THÊM SỰ KIỆN TOGGLE KHI BẤM NÚT MENU BARS */}
          <button
      ...
      <div className="flex pt-14">
        ...
        {/* ✅ LỚP PHỦ MỜ KHI SIDEBAR OPEN TRÊN MOBILE (NẾU CẦN) */}
        {isMobileOpen && (
          <div
                    ...
                    <thead>
                      <tr className="border-b border-slate-100 bg-slate-50">
                        {[
                          ...
                          <th
                            key={index}
                            className="px-4 py-3.5 text-left text-xs font-bold tracking-wide whitespace-nowrap text-slate-500 uppercase"
                          >
                            {h}
                          </th>
                        ))}
                      ...
                      {warehouses.map((w) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <td className="px-4 py-3.5">
                              <p
                                className="max-w-[140px] truncate font-semibold text-slate-800"
                                title={w.name}
                              >
                                {w.name || '—'}
                              </p>
                            ...
                            <td className="max-w-[150px] px-4 py-3.5">
                              <p className="truncate text-xs text-slate-500" title={w.address}>
                                {w.address || '—'}
                              </p>
                            </td>
                            <td className="px-4 py-3.5">
