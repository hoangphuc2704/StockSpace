        ...
        <div className="mb-6 flex items-start justify-between">
          <div>
            ...
            <h2 className="mt-2 text-xl font-bold text-slate-900">
              {packageToEdit ? 'Edit listing package' : 'New listing package'}
            </h2>
            <p className="mt-1 text-sm text-slate-500">
              Separate from tenant service subscriptions.
            </p>
          </div>
          <button
            type="button"
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              maxLength={150}
              placeholder="Featured warehouse"
...
const ListingPackagesPage = () => {
  ...
  const togglePackage = async (pkg) => {
    try {
      ...
      toast.success(
        isPackageActive(pkg) ? 'Listing package deactivated.' : 'Listing package activated.'
      )
      loadPackages()
    } catch (error) {
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
              <div>
                ...
                <p className="mt-1 max-w-2xl text-sm text-slate-500">
                  Manage the visibility packages owners can purchase to publish or renew a warehouse
                  listing.
                </p>
              </div>
              <Button
                            ...
                            <td className="px-6 py-4">
                              <div className="flex justify-end gap-2">
                                ...
                                <button
                                  ...
                                  className={`rounded-lg px-3 py-2 text-xs font-bold ${active ? 'text-amber-700 hover:bg-amber-50' : 'text-emerald-700 hover:bg-emerald-50'}`}
                                >
